...
public class SendPackageOrderDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_send_package_order_details, container, false);
    ...
    private void getItems() {
        db.getReference().child("userData").child(FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber())
                .child("sendPackageOrders").child(key).child("orderItems").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void getOrderDetails(){
        db.getReference().child("userData").child(FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber())
                .child("sendPackageOrders").child(key).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                pickupAddress.setText(snapshot.child("deliveryAddress").getValue().toString());
